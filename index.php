...
<body>
    ...
    <div class="container cont">
        ...
        <img src="image/favicon.jpg" width="90" height="90" class="rounded-circle"><h1>Welcome to Bloodbank</h1>
            <p>We are here to make a difference.</p>
        </div>

        <div class="slideshow-container center-align">
        <img class="mySlides framed-image" src="image/image1.jpeg" style="width:100%">
        <img class="mySlides framed-image" src="image/image2.jpg" style="width:100%">
        <img class="mySlides framed-image" src="image/image3.jpg" style="width:100%">
    </div>

    <!-- Include JavaScript for the slideshow -->
